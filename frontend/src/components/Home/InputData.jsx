  ...
  return (
    ...
    <div className={`${InputDiv} top-0 left-0 flex items-center justify-center h-screen w-full`}>
      ...
      <div className='flex justify-end'>
        <button className='text-xl text-gray-300'  onClick={()=>{setInputDiv("hidden");
        setData({
           title:"",
          desc:"",
        });
      setUpdatedData({
        ...
        <input type="text" placeholder='Title' name='title' className='px-3 my-3 py-2 w-full bg-gray-700 rounded 
        ' value={Data.title}
        onChange={change}/>
        <textarea name="desc" cols="30" rows="10" placeholder='Description...' className='px-3 py-2 rounded w-full bg-gray-700 my-3'  value={Data.desc} onChange={change}>
